    ...
    <div class ='card-deck mt-4'>
        <a href="#" class ='btn' style='text-align:left; padding:0px; margin:0px;'>
           <div class ="card">
            ...
            <div class="card-footer">
                <a class ="btn btn-primary text-white font-weight-bolder float-right"href ="van.php">View more </a>
    ...
    <div class ='card-deck mt-4'>
        <a href="#" class ='btn' style='text-align:left; padding:0px; margin:0px;'>
           <div class ="card">
            ...
            <div class="card-footer">
                <a class ="btn btn-primary text-white font-weight-bolder float-right"href ="barca.php">View more </a>
